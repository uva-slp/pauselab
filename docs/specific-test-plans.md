...
3. Part5.3. The easiest way to do this step is comment out all of the existing code, then edit/add the correct code.
...
The system runs correctly on Microsoft Edge and iOS devices. The system fulfills all given requirements on Firefox, Chrome, Safari and android devices.
