  ...
  describe "when creating a proposal comment" do
    ...
    describe "GET #show" do
      it "assigns the requested category to @ccategory" do
        ...
        get :show, params: {proposal_id: proposal.id, id: proposal_comment.id}
        expect(assigns(:proposal_comment)).to eq(proposal_comment)
      end
    end
    ...
    describe "GET #edit" do
      it "assigns the requested category to @ccategory" do
        proposal = create :proposal
        proposal_comment = create :proposal_comment, proposal: proposal
        get :edit, params: {proposal_id: proposal.id, id: proposal_comment.id}
        expect(assigns(:proposal_comment)).to eq(proposal_comment)
      end
    end
